...
var style_POLE_REGION4A_15 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    if (size == 1) { // If cluster has one feature
        ...
        if (feature.get("pole id") !== null) {
            labelText = String(feature.get("pole id"));
        }
    ...
    var style = [ new ol.style.Style({
        image: new ol.style.RegularShape({radius: 4.0 + size,
                                          ...
                                          angle: Math.PI / 4,
                                          displacement: [0, 0],
                                          stroke: new ol.style.Stroke({color: 'rgba(47,253,11,1.0)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 0.0}),
        ...
        image: new ol.style.Circle({radius: 6.0 + size,
            displacement: [0, 0], stroke: new ol.style.Stroke({color: 'rgba(13,246,9,1.0)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 1.52}), fill: new ol.style.Fill({color: 'rgba(255,0,0,0.0)'})}),
        text: createTextStyle(feature, resolution, labelText, labelFont,
                              labelFill, placement, bufferColor,
                              bufferWidth)
    })];
